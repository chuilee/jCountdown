...
$.fn.countdown = function( method /*, options*/ ) {
	...
	var defaults = {
		...
		generate_template = function( settings ) {
			...
			//$element.addClass( settings.wrapClass )
			...
			/*
			template = "%y <span class='"+ settings.wrapClass +"'>"++"</span>"; 
			template = " %d <span class='"++"'>"++"</span>"; 
			template += " %h <span class='"++"'>"++"</span>";
			template += " %i <span class='"++"'>"++"</span>";
			template += " %s <span class='"++"'>"++"</span>",
			*/
